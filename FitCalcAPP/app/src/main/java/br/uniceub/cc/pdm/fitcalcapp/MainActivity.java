            ...
            public boolean onTouch(View v, MotionEvent event) {
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_UP:
                        ...
                        if (x2 - x1 > 100) { // Swipe para a direita (tela atual sai à esquerda, nova entra pela direita)
                            ...
                            new android.os.Handler().postDelayed(() -> {
                                CarregarCalculadoraPesoIdeal();
                                LinearLayout calc_peso_layout = findViewById(R.id.calc_peso_layout);
                                calc_peso_layout.setVisibility(View.VISIBLE); // Garantir visibilidade antes da animação
                                calc_peso_layout.startAnimation(slideInRight);
                            }, slideOutLeft.getDuration());
                        }

                        if (x1 - x2 > 100) { // Swipe para a esquerda (tela atual sai à direita, nova entra pela esquerda)
                            ...
                            calc_imc.startAnimation(slideOutRight);

                            new android.os.Handler().postDelayed(() -> {
                                CarregarCalculadoraAlturaIdeal();
                                LinearLayout calc_altura = findViewById(R.id.calc_altura);
                                calc_altura.setVisibility(View.VISIBLE); // Garantir visibilidade antes da animação
                                calc_altura.startAnimation(slideInLeft);
                            }, slideOutRight.getDuration());
                        }
                ...
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_UP:
                        ...
                        if (x2 - x1 > 100) { // Swipe para a direita
                            ...
                            new android.os.Handler().postDelayed(() -> {
                                calc_peso_layout.setVisibility(View.GONE); // Oculta o layout atual
                                CarregarCalculadoraIMC(); // Carrega o novo layout
                                LinearLayout calc_imc = findViewById(R.id.calc_imc); // Atualiza a referência
                                calc_imc.setVisibility(View.VISIBLE); // Torna o novo layout visível
                        ...
                        if (x1 - x2 > 100) { // Swipe para a esquerda
                            ...
                            calc_peso_layout.startAnimation(slideOutRight);

                            new android.os.Handler().postDelayed(() -> {
                                calc_peso_layout.setVisibility(View.GONE); // Oculta o layout atual
                                CarregarCalculadoraAlturaIdeal(); // Carrega o novo layout
                                LinearLayout calc_altura = findViewById(R.id.calc_altura); // Atualiza a referência
                                calc_altura.setVisibility(View.VISIBLE); // Torna o novo layout visível
                                calc_altura.startAnimation(slideInLeft);
                            }, slideOutRight.getDuration()); // Ajuste o delay conforme necessário
                        }
                        return true;
                    default:
                        return false;
